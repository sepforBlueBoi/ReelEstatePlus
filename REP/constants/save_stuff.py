game_dict: dict[str, any] = {
    ...
    "shop": { #replica of all items but with prices.
        ...
        "Weird_House": {"tag": "house", "price": 6300, "desc": "This house has 20 bathrooms. 19 of them have toilets. 1 has a urinal."},
        "Box": {"tag": "house", "price": 2, "desc": "how...is this a house?"},
        "Casino": {"tag": "house", "price": 9500, "desc": "Not a house. but you can live in it. Something inside wants you.", "lock": True},
        ...
        "colored_rod": {"tag": "ocean", "price": 600, "desc": "comes in many different colors", "colors": ["red", "orange", "yellow", "green", "blue", "indigo", "pruple"],
                        "color_owned": ""},
        "efficent_rod": {"tag": "ocean", "price": 800, "desc": "Great rod. good for fishing at the beach"},
