...
### day 1
im starting the Dev log on jan. 29 2026. just to clarify, this is NOT when i stared the game. it started in early 2025, but ive been slapped around.
...
1:06: turns out was a bug in save_stuff.py. fixed it. also i am trying to make sure when switching areas it feels smooth and not cluttered. tokens is ALMOST done. a few more lines of time.sleep(), some testing, repeat till its done.
